...
INSERT INTO "new_Match" ("id", "sinkUserFeedback", "sinkUserId", "sourceUserFeedback", "sourceUserId", "status") SELECT "id", "sinkUserFeedback", "sinkUserId", "sourceUserFeedback", "sourceUserId", "status" FROM "Match";
DROP TABLE "Match";
